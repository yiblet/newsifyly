...
//        mCloseAnimatorSet.play(collapseAnimator);
    ...
    private Drawable openedIcon = mIcon;
    private Drawable closedIcon = mIcon;

    public void setOpenedIcon(Drawable drawable) {
        openedIcon = drawable;
    }

    public void setClosedIcon(Drawable drawable) {
        closedIcon = drawable;
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    if (buttonPressListener != null) {
                        buttonPressListener.onClose(this);
                    }
                    close(mIsAnimated);
                    handled = true;
            }
    ...
    public void toggle(boolean animate) {
        if (isOpened()) {
            ...
            if (buttonPressListener != null) {
                buttonPressListener.onOpen(this);
            }
            open(animate);
        }
    }
